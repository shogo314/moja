...
void solve() {
    ...
    std::cin >> q;
    if (q == 0) {
        std::cout << R.__sum__() << std::endl;
    } else if (q == 1) {
        std::cout << R.size() << std::endl;
    } else if (q == 2) {
        int x;
        std::cin >> x;
        assert(0 <= x and x < R.size());
        std::cout << R.at(x) << std::endl;
    } else if (q == 3) {
        int x;
        std::cin >> x;
        assert(R.contains(x));
        std::cout << R.index(x) << std::endl;
    } else if (q == 4) {
        int x;
        std::cin >> x;
        std::cout << R.count(x) << std::endl;
    } else if (q == 5) {
        assert(C > 0);
        int x;
        std::cin >> x;
        std::cout << std::distance(R.begin(), R.lower_bound(x)) << std::endl;
    } else if (q == 6) {
        assert(C > 0);
        int x;
        std::cin >> x;
        std::cout << std::distance(R.begin(), R.upper_bound(x)) << std::endl;
    } else {
        exit(1);
    }
}
